...
public class EnemyMoveState : UnitState<Enemy>
{
	...
	public override void Enter()
	{
		...
		_seq.Append(_owner.VisualPivotTrm.DOLocalRotate(new Vector3(0, 0, 7f), 0.3f).SetEase(Ease.InOutSine).SetLoops(int.MaxValue, LoopType.Yoyo));
		_seq.Join(_owner.VisualPivotTrm.DOLocalMoveY(0.001f, 0.15f).SetEase(Ease.OutQuad).SetLoops(int.MaxValue, LoopType.Yoyo));
